...
/* harmony import */ var _account_caiwu_vue_vue_type_style_index_0_id_73fcd936_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./account_caiwu.vue?vue&type=style&index=0&id=73fcd936&scoped=true&lang=css& */ 82);
...
var _default = {
  ...
  computed: {
    pendingList: function pendingList() {
  ...
  methods: {
    ...
    handleApprove: function handleApprove(remark) {
      var _this = this;
      var index = this.applications.findIndex(function (i) {
        return i.id === _this.currentItem.id;
      });
      this.applications[index] = _objectSpread(_objectSpread({}, this.currentItem), {}, {
        status: 'approved',
        approver: '财务部-张会计',
    ...
    handleReject: function handleReject(remark) {
      var _this2 = this;
      if (!remark.trim()) {
        uni.showToast({
          title: '请填写驳回理由',
      ...
      var index = this.applications.findIndex(function (i) {
        return i.id === _this2.currentItem.id;
      });
      this.applications[index] = _objectSpread(_objectSpread({}, this.currentItem), {}, {
        status: 'rejected',
        approver: '财务部-张会计',
